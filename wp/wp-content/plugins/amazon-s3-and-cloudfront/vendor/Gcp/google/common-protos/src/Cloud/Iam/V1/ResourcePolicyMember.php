 ...
 */
class ResourcePolicyMember extends \DeliciousBrains\WP_Offload_Media\Gcp\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \DeliciousBrains\WP_Offload_Media\Gcp\GPBMetadata\Google\Iam\V1\ResourcePolicyMember::initOnce();
